    ...
    function () {
      ...
      _createClass(CovidComponent, [{
        ...
        value: function ResultsAdder() {
          ...
          console.log(CovidComponent.arr2); // console.log("Level=" + this.Levels)
